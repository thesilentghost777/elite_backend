...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'durees_disponibles' => 'durées disponibles',
        'durees_disponibles.*' => 'durée',
        'diplomes_possibles' => 'diplômes possibles',
        'diplomes_possibles.*' => 'diplôme',
        'prix_points' => 'prix en points',
        'prix_fcfa' => 'prix réel (FCFA)',
        'debouches' => 'débouchés professionnels',
        'debouches.*' => 'débouché',
        'profiles' => 'profils de carrière associés',
        'profiles.*' => 'profil',
        'active' => 'statut actif',
        'code' => 'code caisse',
        'montant' => 'montant',
