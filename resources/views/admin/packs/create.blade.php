...
<div class="page-header">
    <h1 class="page-title">Créer un Pack</h1>
    <p class="page-description">Remplissez les informations pour créer un nouveau pack de formation</p>
</div>
...
<form action="{{ route('admin.packs.store') }}" method="POST" class="space-y-6">
    @csrf
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                    ...
                    <div class="form-group">
                        ...
                        <select name="niveau_requis" 
                            ...
                            <option value="BEPC" {{ old('niveau_requis') == 'BEPC' ? 'selected' : '' }}>BEPC</option>
                            <option value="Probatoire" {{ old('niveau_requis') == 'Probatoire' ? 'selected' : '' }}>Probatoire</option>
                            <option value="BAC" {{ old('niveau_requis') == 'BAC' ? 'selected' : '' }}>BAC</option>
    ...
    <div class="form-actions">
        <a href="{{ route('admin.packs.index') }}" class="btn-cancel">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
